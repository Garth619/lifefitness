											  ...
											  <div class="cactus-listing-heading fix-channel">
												  <div class="navi-channel">                                        	
													  <div class="subs pull-right">                                            	
														  <?php cactus_print_social_share($class_css = 'change-color', $id_cr_pos); ?>                                              
													  </div>
													  
													  <div class="navi pull-left">
														  <a href="<?php echo add_query_arg( array('list' => $id_cr_pos), get_the_permalink() );?>" class="btn btn-default"><i class="fa fa-play-circle"></i> <?php esc_html_e('Play All Videos','cactus');?></a>
													  </div>
