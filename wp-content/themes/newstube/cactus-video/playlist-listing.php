                ...
                <div class="row">
                    ...
                    <div class="col-md-12 cactus-listing-content main-content-col">
                		...
                		<div class="cactus-listing-heading">
                            <h1><?php esc_html_e('Playlists', 'cactus');?></h1>
                        </div>
                        <?php 
                        ...
                        <?php }?>
						<div class="page-navigation"><?php cactus_paging_nav('.cactus-listing-config.playlist-no .cactus-sub-wrap','cactus-channel/content-playlist', esc_html__('Load More Playlists','cactus')); ?></div>
                        <?php 
						wp_reset_postdata();
						if($it>0){
						  $wp_query = $main_query;
