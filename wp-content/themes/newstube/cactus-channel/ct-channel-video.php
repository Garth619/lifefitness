            ...
            <ul>
                <li>
                    <?php if(isset($_GET['sortby'])){ 
						if($_GET['sortby'] =='like'){ esc_html_e('top likes','cactus');}
						elseif($_GET['sortby'] =='view'){ esc_html_e('top viewed','cactus');}
						elseif($_GET['sortby'] =='comment'){ esc_html_e('top comments','cactus');}
						else{ _e('latest','cactus');}
						
					}else{ esc_html_e('latest','cactus');}?> <i class="fa fa-sort-desc"></i>
                    <ul>
                    	<?php if((isset($_GET['sortby']) && ($_GET['sortby'])!='latest')){ ?>
                        <li><a href="<?php echo add_query_arg( array('sortby' => 'latest'), get_the_permalink() ); ?>" title=""><?php esc_html_e('latest','cactus'); ?></a></li>
                        <?php }
						if(!isset($_GET['sortby']) || (isset($_GET['sortby']) && ($_GET['sortby'])!='like')){ ?>
                        <li><a href="<?php echo add_query_arg( array('sortby' => 'like'), get_the_permalink() ); ?>" title=""><?php esc_html_e('top likes','cactus'); ?></a></li>
                        <?php }
						if(!isset($_GET['sortby']) || (isset($_GET['sortby']) && ($_GET['sortby'])!='view')){ ?>
                        <li><a href="<?php echo add_query_arg( array('sortby' => 'view'), get_the_permalink() ); ?>" title=""><?php esc_html_e('top viewed','cactus'); ?></a></li>
                        <?php }
						if(!isset($_GET['sortby']) || (isset($_GET['sortby']) && ($_GET['sortby'])!='comment')){ ?>
                        <li><a href="<?php echo add_query_arg( array('sortby' => 'comment'), get_the_permalink() ); ?>" title=""><?php esc_html_e('top comments','cactus'); ?></a></li>
                        <?php } ?>
                    </ul>
                </li>
    ...
    <?php }else{
		esc_html_e("There isn't any video in this channel","cactus");
	}
