<div class="main-about">
    ...
    <div class="channel-information">
		...
		if($playlist_query->have_posts()){
		 ...
		 wp_reset_postdata();
		?>                                       	
        <span><i class="fa fa-play-circle"></i> <?php echo $n_video; esc_html_e(' videos','cactus'); ?></span>
        <span><i class="fa fa-users"></i> <?php echo $subscribe_counter; esc_html_e(' subscribers ','cactus'); ?></span>
        <span><i class="fa fa-eye"></i> <?php echo $view_channel; esc_html_e(' views','cactus'); ?></span>
    </div>
