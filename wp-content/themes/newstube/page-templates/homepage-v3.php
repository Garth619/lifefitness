...
<!-- Retina Logo-->
    <style type="text/css" >
        @media only screen and (-webkit-min-device-pixel-ratio: 2),(min-resolution: 192dpi) {
            /* Retina Logo */
            .is-sticky-menu img, .cactus-logo-nav img {content:url(<?php echo get_template_directory_uri() . '/images/logo-demo/newstube-video-sticky-logo3-2x.png'; ?>)}
        }
    </style>
...
<div id="body-wrap">
    ...
    if((is_front_page() && $page_on_front != 0) || is_page_template('page-templates/homepage-v3.php'))
    {
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo esc_url(home_url()); ?>">
                            <div class="primary-logo">
                                <img src="<?php echo get_template_directory_uri() . '/images/logo-demo/newstube-video-sticky-logo3-1x.png'; ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>">
                            </div>
                        </a><!--logo-->
                    </div><!--Logo-->
