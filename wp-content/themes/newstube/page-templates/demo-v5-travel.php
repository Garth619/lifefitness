<?php 
/*
 * Template Name: Demo Home V5 Travel
 */
 ?>
<?php 
global $ctdemo_main_color;
$ctdemo_main_color ='#94dbd6';
?><!DOCTYPE html>
<!--[if IE 7]>
...
<!-- Retina Logo-->
	<style type="text/css" >
		@media only screen and (-webkit-min-device-pixel-ratio: 2),(min-resolution: 192dpi) {
			/* Retina Logo */
			.primary-logo{background:url(<?php echo get_template_directory_uri() . '/images/logo-demo/005-Newstube-logo-Travel2X.png'; ?>) no-repeat center; display:inline-block !important; background-size:contain;}
			.primary-logo img{ opacity:0; visibility:hidden}
			.primary-logo *{display:inline-block}
			.cactus-sticky-menu .cactus-logo-nav.is-sticky-menu li a span{background:url(<?php echo get_template_directory_uri() . '/images/logo-demo/001-012-travel-sticky-2X.png'; ?>) no-repeat center; display:inline-block !important; background-size:contain;}
			.cactus-sticky-menu .cactus-logo-nav.is-sticky-menu li img{ opacity:0; visibility:hidden}
		}
		.cactus-note-cat{ background-color:#94dbd6 !important;}
		.thumb-absolute .cactus-note-cat,
		.cactus-note-cat a{color:#222 !important;}
	</style>
...
?>
<div id="body-wrap" class="fixPosition">
...
<header class="fixPosition">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="<?php echo esc_url(home_url()); ?>">
                            <div class="primary-logo">
                                <img src="<?php echo get_template_directory_uri() . '/images/logo-demo/005-Newstube-logo-Travel1X.png'; ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>">
                            </div>
                        </a><!--logo-->
                    </div><!--Logo-->
                ...
                <div class="container">
                    <div class="main-menu-wrap">
                        <ul class="nav navbar-nav cactus-logo-nav is-sticky-menu">
                            <li><a href="<?php echo esc_url(home_url()); ?>"><span><img src="<?php echo get_template_directory_uri() . '/images/logo-demo/001-011-travel-sticky-1X.png'; ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>"></span></a></li>
                        </ul>
                        <?php if($navigation_style == 'style_3'):?>
                            ...
                            <ul class="nav navbar-nav cactus-logo-nav">
                                <li><a href="<?php echo esc_url(home_url()); ?>"><img src="<?php echo get_template_directory_uri() . '/images/logo-demo/001-011-travel-sticky-1X.png'; ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?>" title="<?php echo esc_attr(get_bloginfo('name')); ?>"></a></li>
                            </ul>
                        <?php endif;?>
    ...
    <?php
		...
		$featured_post_layout       = 'posts_thumb_slider';
