...
class easy_tab_widget extends WP_Widget {
	function __construct() {
		...
		parent::__construct( /* Base ID */'easy_tab_widget', /* Name */'Easy Tab Widget', array( 'description' => 'Displays widgets in a tab' ) );
	}
	...
	function form($instance) {		
		...
		$preset = isset($instance['preset']) ? $instance['preset'] : 1;
...
class easy_tab_widget_divider extends WP_Widget{
	...
	function __construct() {
		// widget actual processes
		$widget_ops  = array('classname' => 'easytabdivider', 'description' => 'Divide widgets into tabs. Used for Easy Tab Widget');
		$control_ops = array('width' => 0, 'height' => 0);
		
		parent::__construct( /* Base ID */'easytabdivider', 
							/* Name */'Easy Tab Divider', 
							$widget_ops, 
							$control_ops );
	}
...
if( !function_exists('register_easy_tab_widget')){
	add_action('widgets_init', 'register_easy_tab_widget');
	function register_easy_tab_widget() {
	    register_widget('easy_tab_widget');
		register_widget('easy_tab_widget_divider');
	}
}

add_action('init','easy_tab_setup');
function easy_tab_setup(){
	$number_of_tabs = apply_filters('easy-tab-number-of-tabs','');
